/*
 * FROZEN ORACLE for the audio rewrite (card A0). Verbatim copy of
 * FlySight/audio_control.c at the start of Phase A. DO NOT EDIT: it is the
 * differential-testing reference the fuzzer compares the live module
 * against. Deleted at card C1 when the rewrite is complete.
 */
